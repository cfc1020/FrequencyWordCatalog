...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	hEdit = CreateWindow("Edit", NULL, WS_BORDER | WS_CHILD | WS_VISIBLE | NULL | NULL, 10,10,200,20,hWnd,NULL,hInst,0); 
	return TRUE;
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_RUN:
			wchar_t str[BUFSIZ]; 
			SendMessage(hEdit,WM_GETTEXT,BUFSIZ,LPARAM(str));
      frequency_word words(std::wstring(str).c_str());
      words.run();
        ...
        for (size_t i = 0; i < 10 && i < arr_word.size(); ++i, y += 20)
			{
				...
				SetWindowText(hwnd_st_u, arr_word[i].first.c_str());
				...
				hwnd_ed_u = CreateWindow("edit", "",
					...
					hWnd, (HMENU)(502),
					(HINSTANCE) GetWindowLong (hWnd, GWL_HINSTANCE), NULL);
				SetWindowText(hwnd_ed_u, arr_word[i].first.c_str());
				x = 10; w = 50;
			}
			break;
		default:
